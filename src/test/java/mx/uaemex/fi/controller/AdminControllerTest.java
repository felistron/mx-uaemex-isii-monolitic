...
import mx.uaemex.fi.service.CustomUserDetailsService;
import mx.uaemex.fi.service.EmpleadoService;
import mx.uaemex.fi.service.JwtServiceImp;
import mx.uaemex.fi.service.NominaService;
import mx.uaemex.fi.validation.PeriodoValidator;
import mx.uaemex.fi.validation.RFCExistsValidator;
...
class AdminControllerTest {
    ...
    void verEmpleadoConMultiplesNominas() throws Exception {
        var mockEmpleado = Mockito.mock(Empleado.class);
        var nominas = java.util.Arrays.asList(
                Mockito.mock(Nomina.class),
                Mockito.mock(Nomina.class),
                Mockito.mock(Nomina.class)
        );
